  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050505] relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(220,38,38,0.32),transparent_28%),radial-gradient(circle_at_75%_15%,rgba(59,130,246,0.22),transparent_24%),linear-gradient(135deg,#090909_0%,#151515_46%,#050505_100%)]"></div>
        <div className="absolute inset-0 opacity-20 [background-image:linear-gradient(rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] [background-size:88px_88px]"></div>
        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-[linear-gradient(90deg,rgba(255,255,255,0.08)_0_1px,transparent_1px_42px)] opacity-20 skew-y-[-8deg] scale-125"></div>
      ...
      <div className="w-full max-w-md p-8 sm:p-10 bg-black/60  rounded-2xl shadow-2xl border border-white/10 relative z-10 mx-4 transition-all duration-500 hover:border-white/20 hover:shadow-red-900/10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm font-medium tracking-wide">Enter your IPTV credentials to start streaming</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Server URL</label>
          ...
          >
            {isSubmitting ? (
              ...
              <>Connect <Play size={20} fill="currentColor" /></>
            )}
          </button>
        </form>

        <div className="mt-8 text-center border-t border-white/5 pt-6">
          <p className="text-xs text-gray-500 font-mono">Compatible with the Xtream Codes API</p>
        </div>
      </div>
    </div>
  );
