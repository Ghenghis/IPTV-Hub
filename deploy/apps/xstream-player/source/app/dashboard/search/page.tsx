    ...
    useEffect(() => {
        const loadCatalog = async () => {
            ...
            try {
                ...
                setError("Failed to index content for search. Please check your connection.");
            } finally {
                setInitialLoading(false);
            }
        };
        ...
        <div className="min-h-full flex flex-col space-y-8 p-4 md:p-6 lg:p-10">
            ...
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-gray-400 mt-1 text-sm md:text-base">Find your favorite movies, series, and channels.</p>
                </div>
            ...
            <div className="flex-1 min-h-[300px]">
                {initialLoading && results.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-gray-500 space-y-4">
                        ...
                        <p className="animate-pulse">Indexing catalog...</p>
                    </div>
                ) : query.length < 2 ? (
