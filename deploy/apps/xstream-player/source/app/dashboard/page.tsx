                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 mb-6">
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 p-6 z-20 w-full">
                            ...
                            <p className="text-gray-300 text-sm line-clamp-1">Latest releases and classics.</p>
                        </div>
                    </Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gradient-to-br from-[#1a1a1a] to-[#222] rounded-xl p-6 border border-[#333] flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-white font-bold mb-2">
                            {isConfigured ? 'TMDb Experience Active' : 'Configure TMDb'}
                        </h3>
                        <p className="text-gray-400 text-sm">
                            {isConfigured
                                ? 'Personalized carousels with TMDb content available in your IPTV catalog.'
                                : 'Configure your API key to see TMDb suggestions filtered by your catalog.'}
                        </p>
                        {!isConfigured && (
                            <button
                                onClick={() => setShowSettings(true)}
