...
const menuItems = [
    ...
    { name: 'Live TV', icon: Tv, path: '/dashboard/live' },
    { name: 'Movies', icon: Film, path: '/dashboard/movies' },
    { name: 'Series', icon: Layers, path: '/dashboard/series' },
];
        ...
        <aside className="hidden md:flex w-20 lg:w-72 h-full bg-black/60  border-r border-white/10 flex flex-col transition-all duration-300 relative z-50">
                ...
                <div className="flex flex-col ml-0 lg:ml-4 overflow-hidden">
                    ...
                    {lastSync && (
                        <span className="text-[10px] text-gray-500 hidden lg:block uppercase tracking-tighter">
                            Synced on: {new Date(lastSync).toLocaleDateString()}
                        </span>
                    )}
                </div>
            </div>
            ...
            <div className="p-2 lg:p-6 space-y-4 border-t border-white/5">
                ...
                >
                    ...
                    <span className="hidden lg:block font-medium">Subtitles</span>
                </button>
                ...
                >
                    ...
                    <div className="hidden lg:flex flex-col items-start min-w-5">
                        ...
                        {isSyncing && (
                            <span className="text-[10px] text-gray-500">{syncProgress}% complete</span>
                        )}
                    </div>
                </button>
