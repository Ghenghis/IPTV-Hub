...
| **Provider-vault web** | xstream-player, smart-iptv-web, iptv-stream, iptv-player-zero, nuvioweb, iptvnator, extreme-infinitv, wizju-iptv-player, stalker-ui, iptv-restream | DaveTV server-side vault endpoints and safe same-origin stream/catalog URLs |
